  ...
  return (
    <div className="mt-[7%]">
      <div className="flex flex-col justify-center items-center">
        ...
        <div className="mt-10 lg:flex flex-col items-center justify-center space-y-6 hidden">
        ...
        <div className="mt-10 md:grid grid-cols-1 items-center justify-center space-y-6 gap-5 lg:hidden">
         
          <div className="w-[90%] mx-auto h-full py-8 border border-white border-opacity-20  rounded-2xl flex flex-col justify-center items-center space-y-5">
            <div className="bg-gray-300 bg-opacity-20 rounded-full p-4 ">
              <FaTaxi size={36} />
            </div>
            <div className="text-center flex flex-col space-y-4">
