...
<div className="flex justify-around group-hover:hidden">
  <div className="text-center text-gray-500">
    ...
    <h2 className="line-clamp-5 text-[14px] font-semibold"> <PiSteeringWheelFill className="w-full text-[22px] mb-2" />
     <span className='line-clamp-5 text-[12px] font-medium'>{driver.carType}</span> 
    </h2>
  </div>
  
  <div className="text-center text-gray-500">
  
    <h2 className="line-clamp-5 text-[14px] font-light"><VscWorkspaceTrusted className="w-full text-[18px] mb-2" />
      <span className='line-clamp-5 text-[12px] font-medium'>  {driver.rating} </span>
