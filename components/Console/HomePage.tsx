      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="flex w-full h-full">
          ...
          <div className="w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/2 p-4">
            <div className="bg-white rounded-lg shadow-md p-6 h-[200px] flex">
              ...
              <div className="w-[30%] flex items-center justify-center">
              <img src="/driver.jpg" height={200} width={200} alt="Rent" className="rounded-[50%] h-[120px] w-[150px]"/>
              </div>
        ...
        <div className="w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/2 p-4">
            ...
            List Now
              ...
              <div className="w-[30%] flex items-center justify-center">
              <img src="/creta.png" height={250} width={250} alt="Rent" className="rounded-[50%] h-[120px] w-[150px]"/>
              </div>
          ...
          <div className="w-3/4 sm:w-1/2 md:w-1/3 lg:w-1/2 p-4">
            <div className="bg-white rounded-lg shadow-md p-6 h-[200px] flex">
              ...
              <div className="w-[30%] flex items-center justify-center">
              <img src="/drivers.png" height={200} width={200} alt="Rent" className=" h-[120px] w-[150px]"/>
              </div>
