...
const FleetList = () => {
    ...
    const handleChange = (e: React.ChangeEvent<HTMLSelectElement> | React.ChangeEvent<HTMLInputElement> | React.ChangeEvent<HTMLTextAreaElement>, category: string) => {
...
<div className="bg-gray=50 h-screen flex items-center justify-center">
        <form
          className="bg-white py-10 px-20 rounded-xl shadow-md w-full md:w-[80%]"
          onSubmit={handleSubmit}
        >
          <h2 className="text-3xl font-bold mb-4 text-center text-black">Become a Host</h2>
          ...
          {currentPage === 1 && (
            <div>
              {/* Page 1 */}
              <h2 className="text-2xl font-bold mb-4 text-black">Host Information</h2>
          ...
          {currentPage === 2 && (
            <div>
              {/* Page 2 */}
              <h2 className="text-2xl font-bold mb-4 text-black">Car Information</h2>
              <div className="flex space-x-4">
                {/* Left Half */}
                <div className="w-1/2 flex flex-col">
                  <div className="mb-4">
