  ...
  return (
    <>
     <div className='  text-black sm:block hidden'>
      ...
      <form
        className='bg-white py-10  rounded shadow-md w-full flex items-center justify-center flex-col  md:w-[60%] '
    ...
    <div className='bg-gray-50 min-h-screen flex items-center justify-center py-6 text-black sm:hidden block '>
      <form
        className='bg-white py-6  rounded shadow-md w-full flex items-center flex-col  '
        onSubmit={handleFormSubmit}
      >
        <h2 className='text-3xl font-bold mb-4 text-center'>
          Driver Registration
