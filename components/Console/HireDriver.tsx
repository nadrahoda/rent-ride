...
const [showToast, setShowToast] = useState<boolean>(false);
  ...
  const filterDriverList=(rating:string)=>{
    const filterList=driversOrgList.filter((item:any)=>item.rating==rating)
  ...
  return (
   ...
   <div className="p-5 sm:px-10 md:px-20 min-h-screen text-black">
    ...
    <DriversFilter driversList={driversOrgList} setRating={(value:string)=>filterDriverList(value)}
